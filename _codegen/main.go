...
var (
	pkg       = flag.String("assert-path", "github.com/giffynet/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/giffynet/testify/_codegen
